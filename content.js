...
const CONTENT = {
  ...
  dtcCodes: [
    ...
    { code: "P0107", title: "MAP Sensor — Signal Voltage Low or Open", note: "MAP = Manifold Absolute Pressure — it tells the ECM the intake pressure/vacuum, which is a big part of how it figures out how much fuel to inject. Check the MAP sensor connector and vacuum hose/port for leaks or a split line.", priority: "medium" },
