...
const CONTENT = {
  ...
  dtcCodes: [
    ...
    { code: "P0230", altCode: "P0231 (per Mud Buddy owner's manual)", title: "Fuel Pump Relay Fault — Low or Open Circuit", note: "★ Matches the #1 field-reported failure on these motors (see Fuel Pump field notes). Source conflict: Briggs' official manual lists this as P0230; Mud Buddy's own owner's manual lists the same fault as P0231. If your MIL blinks either one, treat it the same — check the fuel pump relay and fuel pump module wiring/connector before condemning the pump.", priority: "high" },
    { code: "P0232", title: "Fuel Pump Relay Fault — High Voltage", note: "★ Same circuit as P0230/P0231, opposite fault direction. Both manuals agree on this code number.", priority: "high" },
    ...
    { code: "P0351", title: "Cylinder 1 Ignition Coil Fault", note: "Rough idle / lack of power / stalling on that cylinder.", priority: "medium" },
    { code: "P0352", title: "Cylinder 2 Ignition Coil Fault", note: "Rough idle / lack of power / stalling on that cylinder.", priority: "medium" },
    ...
    { code: "P0562", title: "System Voltage Low", note: "Check battery, charging system, and — very common on marsh/marine rigs — vibration-loosened battery or ground connections. Also check the 120A main breaker at the battery (see Component Locations).", priority: "high" },
    { code: "P0563", title: "System Voltage High", note: "Charging system / regulator issue.", priority: "medium" },
