  ...
  decisionTrees: {
    ...
    "hunts-surges": {
      ...
      steps: {
        ...
        s8: { text: "Check for an intermittent open or short-to-ground in the MAP sensor circuit (wiggle-test the harness while watching a DVOM on the signal wire). Problem found?", yes: { action: "repair:Repair the MAP sensor wiring/connector." }, no: { next: "s9" } },
        s9: { text: "Check TPS operation and verify the throttle linkage isn't sticking, binding, or worn (which can cause an unstable TPS signal). Problem found?", yes: { action: "repair:Free up/lubricate the linkage, or repair the TPS/connector." }, no: { next: "s10" } },
